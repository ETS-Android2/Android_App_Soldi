...
import com.project.soldiapp.fragments.AnalysisFragment;
import com.project.soldiapp.fragments.HomeFragment;
import com.project.soldiapp.fragments.SettingsFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_home:
                ((EditText) findViewById(R.id.inputExpense)).setText("");
                findViewById(R.id.inputExpense).clearFocus();

                String tag = String.valueOf(getSupportActionBar().getTitle());
                if (!tag.equals(getString(R.string.app_name))) { //If i am not already in Home...
            ...
            case R.id.nav_analysis:
                getSupportFragmentManager().beginTransaction().replace(R.id.nav_host_fragment,
                        new AnalysisFragment(), getString(R.string.analysis)).commit();
                getSupportActionBar().setTitle(getString(R.string.analysis));
                break;
            case R.id.nav_settings:
                getSupportFragmentManager().beginTransaction().replace(R.id.nav_host_fragment,
                        new SettingsFragment(), getString(R.string.settings)).commit();
