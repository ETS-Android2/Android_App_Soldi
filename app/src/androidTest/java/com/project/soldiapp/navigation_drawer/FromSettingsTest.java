package com.project.soldiapp.navigation_drawer;
...
public class FromSettingsTest {
    ...
    @Test
    public void testSettingsToHome(){
        ViewInteraction checkedTextView = onView(
    ...
    @Test
    public void testSettingsToAnalysis(){
        ViewInteraction checkedTextView = onView(
    ...
    @Test
    public void testSettingsToSettings(){
        ViewInteraction checkedTextView = onView(
                allOf(withId(R.id.design_menu_item_text),withText(mActivityTestRule.getActivity().getString(R.string.settings)),
                        isDisplayed()));
        checkedTextView.check(matches(isDisplayed()));
